...
export IMAGE_URL=${IMAGE_URL-nexus-docker-nexus.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com/rhtap_qe/github-tests-java-quarkus-ipxbkfdr:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/github-tests-java-quarkus-ipxbkfdr-gitops
